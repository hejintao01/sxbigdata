        ...
        series: [
          {
            ...
            radius: '50%',
            data: [
              { value: 35, name: '高分', itemStyle: { color: '#A5A5A5' } },
              { value: 25, name: '中分', itemStyle: { color: '#FFC000' } },
              { value: 12, name: '低分', itemStyle: { color: '#5B9BD5' } },
              { value: 28, name: '正常分', itemStyle: { color: '#ED7D31' } },
            ],
            label: {
              normal: {
                show: true,
