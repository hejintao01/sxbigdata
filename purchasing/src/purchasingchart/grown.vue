        ...
        series: [
          {
            ...
            radius: '50%',
            data: [
              { value: 35, name: '工匠奖', itemStyle: { color: '#A5A5A5' } },
              { value: 25, name: '协会奖', itemStyle: { color: '#FFC000' } },
              { value: 12, name: '创新奖', itemStyle: { color: '#5B9BD5' } },
              { value: 28, name: '其他', itemStyle: { color: '#ED7D31' } },
            ],
            label: {
              normal: {
                show: true,
