    ...
    <div class="table">
      <div class="content">
        ...
        <div class="contenttitle" v-for="list in listdata" :key="list.pm">
          ...
          <div class="contentfont_box"><span class="contentfont">{{list[1]}}</span></div>
          ...
          <div class="contentfont_box"><span class="contentfont">{{list[6]}}</span></div>
          <div class="contentfont_box"><span class="contentfont">{{list[7]}}</span></div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  created() {
    ...
    console.log('评审专家与采购项目专业不匹配top10this.list', arr);
    // X,Y轴赋值
